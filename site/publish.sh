...
parallel rsync_to_pkg azcopy_to_fileshare aws_s3_sync_to_cloudfare ::: 1
...
rm "${ROOT_FOLDER}"/output-pkgcopy.log "${ROOT_FOLDER}"/output-azcopy.log "${ROOT_FOLDER}"/output-awsS3.log
